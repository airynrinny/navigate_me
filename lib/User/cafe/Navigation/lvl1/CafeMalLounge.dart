...
class CafeMalLoungePage extends StatelessWidget {
  const CafeMalLoungePage({super.key});
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      ListTile(
                        leading:
                            Image.asset('lib/Images/cafe/lvl1/lounge/1.png'),
                      ...
                      ListTile(
                        ...
                        title:
                            const Text('STEP 10: Room nearest to OR entrance'),
                        subtitle: const Text(
                            'Turn right to the room nearest to the OR entrance'),
                      ),
                      ListTile(
                        leading: Image.asset(
