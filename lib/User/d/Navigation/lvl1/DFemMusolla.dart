...
class DFemMusollaPage extends StatelessWidget {
  const DFemMusollaPage({super.key});
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  _ListTile('lib/Images/blockd/lvl1/musolla/1.png',
                  ...
                  _ListTile(
                      ...
                      'STEP 9: Near the main entrance',
                      'Go straight pass through the second glass door'),

                  _ListTile(
                      'lib/Images/blockd/lvl1/musolla/12.png', // Replace 'step3.jpg' with your actual image path
                      'STEP 10: Near the elevator',
                      'After the glass door, turn right'),

                  _ListTile(
                      'lib/Images/blockd/lvl1/musolla/13.png', // Replace 'step3.jpg' with your actual image path
                      'You have arrived!',
                      ''),
                  // ListTile(
