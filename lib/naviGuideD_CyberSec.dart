                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      ListTile(
                        leading: Image.asset('assets/images/blockd-cyber/1.png'),
                        title: const Text(
                      ...
                      ListTile(
                        leading: Image.asset(
                            'assets/images/blockd-cyber/2.png'), // Replace 'step2.jpg' with your actual image path
                        title: const Text('STEP 2: Turn right'),
                        subtitle: const Text('Turn right'),
                      ),
                      ListTile(
                        leading: Image.asset(
                            'assets/images/blockd-cyber/3.png'), // Replace 'step3.jpg' with your actual image path
                        title: const Text(
                      ...
                      ListTile(
                        leading: Image.asset(
                            'assets/images/blockd-cyber/4.png'), // Replace 'step4.jpg' with your actual image path
                        title: const Text('STEP 4: At the corner, turn right'),
                        subtitle: const Text('At the corner, turn right'),
                      ),
                      ListTile(
                        leading: Image.asset(
                            'assets/images/blockd-cyber/5.png'), // Replace 'step4.jpg' with your actual image path
                        title: const Text('STEP 5: Go straight'),
                        subtitle: const Text('Go straight'),
                      ),
                      ListTile(
                        leading: Image.asset(
                            'assets/images/blockd-cyber/6.png'), // Replace 'step4.jpg' with your actual image path
                        title: const Text('STEP 6: Turn right'),
                        subtitle: const Text('Turn right'),
                      ),
                      ListTile(
                        leading: Image.asset(
                            'assets/images/blockd-cyber/7.png'), // Replace 'step4.jpg' with your actual image path
                        title: const Text(
                      ...
                      ListTile(
                        leading: Image.asset(
                            'assets/images/blockd-cyber/8.png'), // Replace 'step4.jpg' with your actual image path
